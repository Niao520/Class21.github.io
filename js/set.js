...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        case "1":
            ...
            break;
        case "2":
            $('#bg').attr('src', 'https://images7.alphacoders.com/132/1329757.png'); //必应每日
            break;
        case "3":
            $('#bg').attr('src', 'https://images7.alphacoders.com/132/1329757.png'); //随机风景
            break;
        case "4":
            $('#bg').attr('src', 'https://images7.alphacoders.com/132/1329757.png'); //随机动漫
            break;
    }
}
